            ...
            <div className="bg-gray-800/50 rounded-lg p-3 mb-6">
              ...
              <p className="text-sm text-gray-300 italic">
                {registrationResult.messageType === 'Failed (will contact manually)' 
                  ...
                  : `"Welcome to AutoNXT, ${registrationResult.data.name}! You're all set for the event, Nov 28 - 30. Your Booking ID: ${registrationResult.bookingId}. Get ready for an amazing expo!"`
                }
              </p>
            </div>
            <button 
